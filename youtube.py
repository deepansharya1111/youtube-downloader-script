...
match download_choice:
	case 'b':
		video_object.streams.get_highest_resolution().download(r'/Users/deepansharya1111/Downloads')
	case 'w':
		video_object.streams.get_lowest_resolution().download(r'/Users/deepansharya1111/Downloads')
	case 'a':
		video_object.streams.get_audio_only().download(r'/Users/deepansharya1111/Downloads')